...
/// <summary>
///     Add/remove <see cref="CyclopsDamagePoint" />s and <see cref="Fire" />s to match the <see cref="CyclopsDamage" />
///     packet received
/// </summary>
internal sealed class CyclopsDamageProcessor(Fires fires) : IClientPacketProcessor<CyclopsDamage>
{
    ...
    /// <summary>
    ///     Add/remove <see cref="CyclopsDamagePoint" />s until it matches the <paramref name="damagePointIndexes" /> array
    ///     passed. Can trigger <see cref="CyclopsDamagePointRepaired" /> packets
    /// </summary>
    ...
    /// <summary>
    ///     Add/remove fires until it matches the <paramref name="roomFires" /> array. Can trigger <see cref="FireDoused" />
    ///     packets
    /// </summary>
    ...
    /// <summary>
    ///     Set the health of a <see cref="CyclopsDamagePoint" />. This can trigger sending
    ///     <see cref="CyclopsDamagePointRepaired" /> packets
    /// </summary>
